...
//======================================================================
  ...
  $mysqlHostName = DB_NAME;

  $file_name = 'ugAdvisorBackup.sql';
  $tmp = explode('.', $file_name);
  $mysqlExportPath = end($tmp);
  ...
  https://www.ionos.com/help/hosting/using-mysql-databases-for-web-projects/backing-up-and-restoring-mysql-databases-using-php/
